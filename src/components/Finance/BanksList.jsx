...
const BankList = () => {
    ...
    function openModal(){
      ...
      const handleSubmit = async(e) => {
        e.preventDefault();
        await axios.post(`${url}/banks`,bankForm,{withCredentials:true}).then((resp)=>{
          if(resp.data.error){
            setOpenError({open:true,message:`${resp.data.error}`})
          }else{
            // console.log(resp.data);
            setBank((prev)=>[...prev,resp.data])
  ...
  const handleDelete = async()=>{
    await axios.delete(`${url}/banks/${isDeleteOpen.id}`,{withCredentials:true}).then((resp)=>{
    ...
    return (
      ...
      {/* Search section */}
        ...
        <div className="relative">
            ...
            dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Banks..." required />
        </div>
      ...
      <ModalHeader>Register Bank</ModalHeader>
      <ModalBody>
