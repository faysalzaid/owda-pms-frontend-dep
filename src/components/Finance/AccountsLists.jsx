      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableCell className="font-semibold">Bank</TableCell>
          ...
          {fetchedResult?fetchedResult.map((row, i) => (
            <Fragment key={i}>
              <TableRow>
                ...
                <TableCell><span className="text-sm font-semibold">{bank.map((bn)=>bn.id==row.owdaBankId?bn.name:"")}</span></TableCell>
                <TableCell><span className="text-sm font-semibold">{accountType.map((bn)=>bn.id==row.owdaAccountTypeId?bn.name:"")}</span></TableCell>
                <TableCell><span className="text-sm font-semibold">{parseFloat(row.remaining).toLocaleString({maximumFractionDigits:2})}</span></TableCell>
                <TableCell className="flex justify-center space-x-2">
                  <Link to={`/app/accounts/${row.id}`}>
