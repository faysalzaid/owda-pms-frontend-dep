...
const AccountTypeList = () => {
    ...
    function openModal(){
      ...
      const handleSubmit = async(e) => {
        e.preventDefault();
        await axios.post(`${url}/accountTypes`,accountTypeForm,{withCredentials:true}).then((resp)=>{
          if(resp.data.error){
            setOpenError({open:true,message:`${resp.data.error}`})
          }else{
            // console.log(resp.data);
            setAccountType((prev)=>[...prev,resp.data])
  ...
  const handleDelete = async()=>{
    await axios.delete(`${url}/accountTypes/${isDeleteOpen.id}`,{withCredentials:true}).then((resp)=>{
    ...
    return (
      ...
      {/* Delete Confirm section */}
        ...
        <Button onClick={openModal} className="custom-button">New Account Type</Button>
  
      
        </TableContainer>

        <Modal isOpen={isOpen} onClose={closeModal}>
      <ModalHeader>Register Account Type</ModalHeader>
      <ModalBody>
